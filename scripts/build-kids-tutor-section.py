...
OUT = SEC / "video/final/LOCKED-14-kids-tutor.mp4"

CARD = SEC / "after/final/title-card-teach-safely.png"
CARD_VO = SEC / "audio/final/teach-safely-card-vo.mp3"
MASTER = SEC / "video/cuts/tutor-body-cut.mp4"
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="dojo-kids-") as td:
        tmp = Path(td)
